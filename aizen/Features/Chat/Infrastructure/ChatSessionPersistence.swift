...
final class ChatSessionPersistence {
    ...
    let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "win.aizen.app", category: "SessionPersistence")
    static let legacyWorktreeMapKey = "chatSession.lastWorktreeBySessionId"
    static let legacyWorkspaceMapKey = "chatSession.lastWorkspaceBySessionId"
    static let legacyRecoveryCompletedKey = "chatSession.legacyDetachedRecovery.completed.v2"
    static let legacyDefaultsDomains = [
        "win.aizen.app",
        "wiedymi.com.aizen",
        "com.aizen.app",
        "aizen"
