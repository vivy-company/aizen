      ...
      <footer className="py-12 px-6 border-t border-white/8 mt-20">
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center md:items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center">
            <a href="https://discord.gg/zemMZtrkSb" className="text-sm text-zinc-500 hover:text-blue-500 transition-colors duration-200" target="_blank" rel="noopener noreferrer">
              {t("footer.discord")}
            </a>
